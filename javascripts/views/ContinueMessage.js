window.require.register("views/ContinueMessage", function(require, module) {moduleLibrary.define('ContinueMessage.View', gamecore.Pooled.extend('ContinueMessageView', {
